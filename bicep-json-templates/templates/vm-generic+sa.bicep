...
param scriptName string = 'vm-install-AzureCLI.ps1'
@description('Enter the name of the CSE script URI (recommended to leave as-is).')
param scriptUris array = ['https://raw.githubusercontent.com/w-plw/cloud-deployment/refs/heads/main/bicep-json-templates/scripts/${scriptName}']
